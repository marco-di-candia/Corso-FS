...
console.log(splitMe("Hello World Ciao Mondo"));
/* ESERCIZIO 4
...
const isThisAnEmail = (string = "") => {
  ...
  return verifica.test(string)
}
console.log(isThisAnEmail("mdicagmaiò@.com1"));
/* ESERCIZIO 7
  Scrivi una funzione chiamata "whatDayIsIt" che ritorna il giorno della settimana corrente.
*/console.log("ESERCIZIO 7");
const whatDayIsIt = () => {
  array = ["Domenica", "Lunerdi", "Martedi", "Mercoledi", "Giovedi", "Venerdi", "Sabato"]
  let data = new Date()
  let oggi = data.getDay()
  return array[oggi];
}
...
const mbd = ()=>{
  let data = new Date()
  let mybd = new Date("11-12")
  if ((mybd.getMonth() === data.getMonth() && mybd.getDate() === data.getDate())) {
    return true
  }else{
    return false
  }
...
const newestMovie = movies.find(({ Year }) => Year < 2040);

console.log(newestMovie);

// non capisco perche non funziona dovrebe uscirmi il primo film minore di 2040!?
...
function  onlyInLastMillennium() {
  ...
  const yearMillennium = [];
  for (let i = 0; i < movies.length; i++) {
    let year = movies[i].Year;
    if (year >= 2000) {
       yearMillennium.push(year)
    } 
  }
  return yearMillennium
