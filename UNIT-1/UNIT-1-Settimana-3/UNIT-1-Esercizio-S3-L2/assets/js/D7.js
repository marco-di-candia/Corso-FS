...
*/
  // function es1 (stringa1 = "" ,stringa2 = "") {
  //   let unisci = stringa1.slice(0,2).concat(stringa2.slice(length - 3)).toUpperCase();
  //  return unisci;
  // }  
  // console.log(es1("hello" , "word"));
...
/* ESERCIZIO 3 (filter)
  ...
  */
 const array = [1,2,3,6,4,12,5,3,3,2,32,5,32,31,3,2] ;

 const es3 = array.filter((Element ) =>
  {
  if (Element % 2 === 0) {
    return Element
  }
...
function es5(totale,valorecorente) {
  return totale + valorecorente
}
console.log(array.reduce(es5)); 
...
const lunghezze = stringhe.map((element,idice)=>{
